...
local grammar = P{"prog",
  ...
  factor = 
      ...
      + strpat / node("string", "val") -- glimmerings of string type TODO: refactor bin op '|' to concat strings 
      + T"(" * shortcct * T")" 
  ...
  while true do 
    ...
    elseif code[pc] == "print" then 
      ...
      if type(stack[top]) == "table" then
        ...
        local chars = splitchars(stack[top])
        print("chars", pt.pt(chars))
...
a = new[4][3];
a[3][3] = 9;
@ "oooo... introducing string type so we can say we got this far";
a[3][5] = 9999;
