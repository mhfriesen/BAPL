  ...
  while true do 
    ...
    elseif code[pc] == "print" then 
      ...
      if type(stack[top]) == "table" and getmetatable(stack[top]) then
        print(stack[top]) -- assume its metatable can print it
...
print"\nFunctions and Unless Now pl -- aka FUN\n"
print("NEW cases")

function CASES() end -- for IDE outline view
local optTrace, n1, n2 = true, 1, 1
cases = {
[[
# what does -"abc" do?, + to coerce string to number
function main ( ) {
  @ -2;
  @ -"abc"
}]]
