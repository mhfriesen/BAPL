...
function primordial_lpeg_patterns_start() end -- for IDE outline view
...
local p_maxmatch = 0 
local space = lpeg.space^0 * function(s,p) p_maxmatch = math.max(p_maxmatch, p); return true end 
local spaces = lpeg.space^1

local nl = lpeg.P("\n")                   -- new line
local nnl = -#(lpeg.P("\n")) * lpeg.P(1)  -- not a new line
