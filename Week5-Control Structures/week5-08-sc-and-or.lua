...
local function composeRel(lst)
  ...
  if 5 < #lst then
    ...
    tree = {tag = "syntaxErr"}
  elseif #lst == 5 then --TODO: restrict to proper transitive rel combinations e.g. disallow a < b > c
